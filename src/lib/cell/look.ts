...
export const KINDS: KindInfo[] = [
  { name: 'Coletora', short: 'COL', blurb: 'Colhe nutrientes e os leva ao biofilme. Não luta: foge do perigo para sobreviver. É ela que se transforma em nódulo de biofilme.', food: 20, energy: 5, time: 4, hp: 30, armor: 0, speed: 46, r: 7, sight: 150, dmg: 0, range: 0, cd: 1.2, pop: 1 },
  ...
  { name: 'Nódulo de biofilme', short: 'NÓD', blurb: 'A coletora mais próxima da colônia nada até o ponto e se transforma: espalha biofilme (território), cura as células e dá +6 de população.', food: 50, energy: 20, time: 6, hp: 180, armor: 2, speed: 0, r: 12, sight: 180, dmg: 0, range: 0, cd: 1, pop: 0 },
